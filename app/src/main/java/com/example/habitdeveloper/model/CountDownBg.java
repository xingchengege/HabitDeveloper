package com.example.habitdeveloper.model;
...
public class CountDownBg extends FrameLayout {

    private com.example.habitdeveloper.model.CountDownBg.OnBallItemListener mOnBallItemListener;
    private com.example.habitdeveloper.model.CountDownBg.OnTipsItemListener mOnTipsItemListener;
    ...
    public CountDownBg(@NonNull Context context) {
        this(context, null);
    }

    public CountDownBg(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownBg(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void addWaterView(List<BallModel> ballList,List<TipsModel> tipsList) {
        ...
        for (int i = 0; i < tipsList.size(); i++) {
            ...
            view.setY((float) ((mHeight * num2[i] * 0.13)));
    ...
    //设置小球点击事件
    public void setOnBallItemListener(com.example.habitdeveloper.model.CountDownBg.OnBallItemListener onBallItemListener) {
        mOnBallItemListener = onBallItemListener;
    }
    //设置提示点击事件
    public void setOnTipsItemListener(com.example.habitdeveloper.model.CountDownBg.OnTipsItemListener onWaterItemListener) {
